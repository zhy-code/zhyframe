		...
		<div class="col-sm-12">
			<form class="form-horizontal" role="form" id="sortserviceshopInfoForm">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input name="sortserviceshop_name" class="form-control" type="text">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-4 control-label">排序：</label>
					<div class="col-sm-6">
						<input name="sortserviceshop_sort" class="form-control" type="text">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-4 control-label">备注：</label>
					<div class="col-sm-6">
						<input name="sortserviceshop_remark" class="form-control" type="text">
					</div>
				</div>
				<div class="form-group mt-50">
					<div class="col-sm-4 col-sm-offset-5 ">
						<span class="btn btn-primary" onclick="layAjaxForm($('#sortserviceshopInfoForm').serialize(), '/admin/sortserviceshop/sortserviceshopaddsave', 'post')">保&nbsp;&nbsp;存</span>
