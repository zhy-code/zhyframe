...
<div class="wrapper animated fadeInRight">
	<div class="ibox float-e-margins">
		<div class="ibox-title">
			<h2>
				商品分类列表
				<button type="button" class="btn btn-outline btn-default pull-right" onclick="layOpenView('/admin/sortgoods/sortgoodsadd','90%','90%','商品分类添加')">
					<i class="fa fa-plus-square-o mr-5" aria-hidden="true"></i>添加商品分类
				</button>
			</h2>
		</div>
