	...
	<div class="row">
		<div class="col-sm-12">
			<div class="ibox-content p-xl">
				<div class="row">
					<div class="col-sm-12">
						<h2>订单编号：<span class="text-navy">{{$goodsshopinfo->goodsshop_id}}</span></h2>
					</div>
				</div>
					...
					<table class="table table-border table-bordered table-bg table-hover table-striped">
						<tbody>
							<tr class="text-center">
								...
								<td>{{$goodsshopinfo->goodsshop_remark}}</td>
							...
							<tr class="text-center">
								...
								<td> {{$goodsshopinfo->goodsshop_status_format}}</td>
							</tr>
							<tr class="text-center">
								<td><strong>支付日期</strong></td>
								<td>{{$goodsshopinfo->goodsshop_add_time_format}}</td>
								<td><strong>确认日期</strong></td>
								<td> {{$goodsshopinfo->goodsshop_confirm_time_format}}</td>
							</tr>
							<tr class="text-center">
							...
							<tr class="text-center">
								...
								<td><img style="width:200px;" src="{{asset($goodsshopinfo->goodsshop_remark)}}" /></td>
