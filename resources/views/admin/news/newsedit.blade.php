		...
		<div class="col-sm-12">
			<form class="form-horizontal" role="form" id="newsInfoForm">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <span class="help-block m-b-none" id="LastImgBtn_A">
							<img src="{{ asset($newsinfo->title_pic)}}" class="WW100">
							<input type="hidden" id="title_pic" name="title_pic" value="{{$newsinfo->title_pic}}">
						</span>
                    </div>
					<div class="col-sm-4">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" name="author" value="{{$newsinfo->author}}">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">来源：</label>
					<div class="col-sm-8">
						<input type="text" class="form-control" name="origin" value="{{$newsinfo->origin}}">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<select class="form-control" name="classify">
							<option>请选择</option>
							<option value="1" @if($newsinfo->classify==1) selected @endif >集团新闻</option>
							<option value="2" @if($newsinfo->classify==2) selected @endif >车型动态</option>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-8">
						<textarea class="form-control" rows="3" name="brief">{{$newsinfo->brief}}</textarea>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-8">
						<div class="ibox-content" style="border-width:1px;border-style: solid;">
							<div class="wrapper" id="editor_content_details">{!! $newsinfo->details !!}</div>
						</div>
					</div>
				</div>
				<div class="form-group mt-50">
					<div class="col-sm-4 col-sm-offset-5 ">
						<span class="btn btn-primary" onclick="sendForm($('#newsInfoForm').serializeArray(), '/admin/news/newseditsave/{{$newsinfo->id}}')">保&nbsp;&nbsp;存</span>
