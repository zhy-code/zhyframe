...
<div class="wrapper animated fadeInRight">
	<div class="ibox float-e-margins">
		<div class="ibox-title">
			<h2>
				服务分类列表
				<button type="button" class="btn btn-outline btn-default pull-right" onclick="layOpenView('/admin/sortservice/sortserviceadd','90%','90%','服务分类添加')">
					<i class="fa fa-plus-square-o mr-5" aria-hidden="true"></i>添加服务分类
				</button>
			</h2>
		</div>
