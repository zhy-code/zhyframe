		...
		<div class="col-sm-12">
			<form class="form-horizontal" role="form" id="sortserviceInfoForm">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<select class="form-control" name="sortservice_shop_id">
							...
							<option value="{{$sortserviceshop->sortserviceshop_id}}">{{$sortserviceshop->sortserviceshop_name}}</option>
							@endforeach
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input name="sortservice_name" class="form-control" type="text">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-4 control-label">排序：</label>
					<div class="col-sm-6">
						<input name="sortservice_sort" class="form-control" type="text">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-4 control-label">备注：</label>
					<div class="col-sm-6">
						<input name="sortservice_remark" class="form-control" type="text">
					</div>
				</div>
				<div class="form-group mt-50">
					<div class="col-sm-4 col-sm-offset-5 ">
						<span class="btn btn-primary" onclick="layAjaxForm($('#sortserviceInfoForm').serialize(), '/admin/sortservice/sortserviceaddsave', 'post')">保&nbsp;&nbsp;存</span>
