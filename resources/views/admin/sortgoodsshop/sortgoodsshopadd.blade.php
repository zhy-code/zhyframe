		...
		<div class="col-sm-12">
			<form class="form-horizontal" role="form" id="sortgoodsshopInfoForm">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input name="sortgoodsshop_name" class="form-control" type="text">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-4 control-label">排序：</label>
					<div class="col-sm-6">
						<input name="sortgoodsshop_sort" class="form-control" type="text">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-4 control-label">备注：</label>
					<div class="col-sm-6">
						<input name="sortgoodsshop_remark" class="form-control" type="text">
					</div>
				</div>
				<div class="form-group mt-50">
					<div class="col-sm-4 col-sm-offset-5 ">
						<span class="btn btn-primary" onclick="layAjaxForm($('#sortgoodsshopInfoForm').serialize(), '/admin/sortgoodsshop/sortgoodsshopaddsave', 'post')">保&nbsp;&nbsp;存</span>
