				...
				<div class="col-sm-12">
					...
					<div class="example-wrap">
						...
						<table id="tableEvents" data-height="auto" data-mobile-responsive="true">
							<thead>
								<tr>
									<th data-field="serviceshop_id">服务商铺ID</th>
									<th data-field="serviceshop_remark">商铺名称</th>
									<th data-field="serviceshop_add_time_format">申请时间</th>
									<th data-field="serviceshop_confirm_time_format">处理时间</th>
									<th data-field="serviceshop_check_format">审核状态</th>
									<th data-field="serviceshop_status_format">商铺状态</th>
									<th data-field="serviceshop_remark">后台备注</th>
									<th data-field="serviceshop_operation">操作</th>
								</tr>
							</thead>
						</table>
					</div>
