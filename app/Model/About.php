...
class About extends Model
{
    ...
    {
        $html  = "<i class='fa fa-edit' onclick=layOpenView('/admin/about/aboutedit/{$this->id}','100%','100%','信息编辑')></i>";
		/*
		if ($this->status) {
			$html .= "<i class='fa fa-level-down ml-15' onclick=layChangeStatus('/admin/about/aboutstatus/{$this->id}/0','隐藏')></i>";
		} else {
			$html .= "<i class='fa fa-level-up ml-15' onclick=layChangeStatus('/admin/about/aboutstatus/{$this->id}/1','展示')></i>";
		}
		*/
		return $html;
    }
